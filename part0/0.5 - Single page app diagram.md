...
sequenceDiagram
  ...
  Note right of browser: 2. XMLHttpRequest.onreadystatechange is triggered to retrieve data.json

  Note right of browser: 2. after parsing the JSON object, execute redrawNotes() to show list on page
